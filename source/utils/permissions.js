...
export const groupedPermissions = {
    ...
    [ ORDERS_PERMISSIONS ]:    [ ACCESS_ORDER_BODY, ACCESS_ORDER_CALLS, ACCESS_ORDER_COMMENTS, ACCESS_ORDER_DETAILS, ACCESS_ORDER_HISTORY, ACCESS_ORDER_SERVICES, ACCESS_ORDER_STATUS, ACCESS_ORDER_TASKS, CREATE_INVITE_ORDER, CREATE_ORDER, GRANT, PRINT_ORDERS, SHOW_FILTERS, SHOW_ORDERS, UPDATE_SUCCESS_ORDER ],
