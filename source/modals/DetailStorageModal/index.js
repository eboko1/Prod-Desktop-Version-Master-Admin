...
class DetailStorageModal extends React.Component{
                    ...
                    return (
                        <Button
                            ...
                            onClick={()=>{
                                ...
                                this.props.setSupplier(elem.businessSupplierId, elem.businessSupplierName, supplierBrandId, elem.purchasePrice, elem.salePrice, elem.store, supplierOriginalCode, this.props.tableKey, isFromStock, defaultWarehouseId, elem.storeId);
                                this.handleCancel();
                            }}
                        >
    ...
    setSupplier(supplierId, businessSupplierName, supplierBrandId, purchasePrice, price, store, supplierOriginalCode, key, isFromStock, defaultWarehouseId, productId) {
