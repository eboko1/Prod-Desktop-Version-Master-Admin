...
import { DecoratedInput, DecoratedSelect, DecoratedDatePicker } from 'forms/DecoratedFields';
import { v4 } from 'uuid';
//proj
...
export class OrderTaskForm extends Component {
    render() {
        ...
        return <Form layout='horizontal'>
            <div > <FormattedMessage id='order-task-modal.order_number'/>: { num }</div>
            ...
            <DecoratedSelect
                ...
                hasFeedback
                label={
                    <FormattedMessage id='progressStatus' />
                }
            ...
            <DecoratedSelect
                ...
                className={ Styles.selectMargin }
                label={
                    <FormattedMessage id='responsable' />
                }
                getFieldDecorator={ getFieldDecorator }

                placeholder={
                    <FormattedMessage id='order_task_modal.responsable_placeholder' />
                }
            ...
            <DecoratedDatePicker
                field='deadlineDate'
                label={
                    <FormattedMessage id='deadlineDate' />
                }
                formItem
                formatMessage={
                    formatMessage
            ...
            <DecoratedInput
                ...
                placeholder={
                    formatMessage({id: 'order_task_modal.comment_placeholder'})
                }
                formItem
                className={ Styles.selectMargin }
