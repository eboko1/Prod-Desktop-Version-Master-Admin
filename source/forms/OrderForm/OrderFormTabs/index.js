...
export default class OrderFormTabs extends React.PureComponent {
	...
	async componentDidUpdate(prevProps, prevState) {
		...
		if (this.props.scrollToMapId) {
			...
			await document
				.getElementById(this.props.scrollToMapId)
	...
	render() {
		...
		const areCommentsForbidden = isForbidden(
			user,
			ACCESS_ORDER_TABS_COMMENTS_CRUD
		);
				...
				{!isForbidden(user, ACCESS_ORDER_COMMENTS) && (
					...
					>
						...
						<DecoratedTextArea
							...
							formItem
							disabled={areCommentsForbidden}
							label={this._getLocalization('add_order_form.vehicle_condition')}
							getFieldDecorator={getFieldDecorator}
						...
						<DecoratedTextArea
							...
							formItem
							disabled={areCommentsForbidden}
							label={this._getLocalization('add_order_form.business_comment')}
							getFieldDecorator={getFieldDecorator}
