...
export class OrderForm extends Component {
    ...
    _renderTotalBlock = () => {
        ...
        const commentCount = () => {
            ...
            if (fields.businessComment && fields.businessComment.value) {
                count = count + 1;
            }
            if (fields.vehicleCondition && fields.vehicleCondition.value) {
                count = count + 1;
            }
            if (fields.recommendation && fields.recommendation.value) {
                count = count + 1;
            }
